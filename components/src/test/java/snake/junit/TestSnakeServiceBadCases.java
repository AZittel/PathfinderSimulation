...
public class TestSnakeServiceBadCases {
    private static final org.slf4j.Logger logger =
            org.slf4j.LoggerFactory.getLogger(de.hhn.it.pp.components.example.coffeemakerservice.junit.TestCoffeMakerServiceBadCases.class);
    ...
    void testExceptionWhenRequestingNonExistentPlayer() {
        IllegalParameterException illegalParameterException = assertThrows(
                ...
                () -> snakePlayerService.getSnakePlayer(23));
    }
