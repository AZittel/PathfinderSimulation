...
public class OurSnakePlayerService implements SnakePlayerService, AdminSnakePlayerService {
    private static final org.slf4j.Logger logger =
            org.slf4j.LoggerFactory.getLogger(OurSnakePlayerService.class);
     ...
     */
    @Override
    public void removeCallback(int id, SnakePlayerListener listener) throws IllegalParameterException {
